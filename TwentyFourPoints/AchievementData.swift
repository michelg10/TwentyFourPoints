...
var achievement: [Achievement] = [
    ...
    Achievement(name: "Ethan",lvlReq: 200,secret:false,description: "When Ethan isn't busy playing or sleeping with his stuffed avocado, he can be seen doing physics or programming. His talent in everything STEM shows in his undeniable 24 Points performance."),
    ...
    Achievement(name: "Mimi",lvlReq: 500,secret:false,description: "When Mimi's not busy writing poetry or managing teams, she's seen at the gym checking out the chads. Mimi's dedication and intellect make her a formidable 24 Points player.",specialThanks: "Special thanks to Mimi for her input and support in designing the app."),
    Achievement(name: "Mike",lvlReq: 750,secret:false,description: "When Mike isn't busy designing or latching speakers playing Justin Bieber onto friends, Mike can be seen playing 24 Points.",specialThanks: "Special thanks to Mike for his frequent suggestions during development."),
    Achievement(name: "Sarah",lvlReq: 1000,secret:false,description: "Sarah's focus on machine learning has given her plenty of time to play 24 Points (and stare at her seven husbands) while she waits for her next state-of-the-art model to finish training."),
