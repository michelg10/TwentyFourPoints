    ...
    var body: some View {
        GeometryReader { _ in
            VStack {
                ...
                ZStack {
                    HStack {
                        CardLayout(tfengine: tfengine, cA: tfengine.cA, cs: tfengine.cs, operational: tfengine.cardsClickable, primID: "CardLayoutView"+tfengine.curQuestionID.uuidString)
